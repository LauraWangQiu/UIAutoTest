...
class GenerateGraph:
    ...
    def __start_executable_in_thread__(self):
        ...
        self.thread = threading.Thread(target=start_executable)
    ...
    def __loop__(self, transition=None):
